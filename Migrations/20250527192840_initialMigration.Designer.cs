...
namespace UniversitySystem.Migrations
{
    ...
    [Migration("20250527192840_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversitySystem.Context.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniversitySystem.Context.Attendance", b =>
                {
                    ...
                    b.HasOne("UnivercitySystem.Models.Student", "Student")
                        .WithOne("Attendances")
                        .HasForeignKey("UniversitySystem.Context.Attendance", "StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
